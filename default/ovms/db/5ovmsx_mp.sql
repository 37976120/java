...
-- ----------------------------
BEGIN;
INSERT INTO `wx_account` VALUES (1, 'ovms测试', 'gh_16138b09b5f9', 'wxeb4543e2d692ec5a', '2e3d89a95aa55a63df11eecdea973662', 'http://ovms.huaxiadaowei.com', 'ovms', 'ovms', 'https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=gQF88TwAAAAAAAAAAS5odHRwOi8vd2VpeGluLnFxLmNvbS9xLzAyWm1EOXNPWEdlS0MxMDAwMGcwM2MAAgQEzslcAwQAAAAA', '2019-05-02 22:14:35', '2019-05-02 22:14:35', '0', 1);
COMMIT;
...
CREATE TABLE `wx_fans_msg` (
  ...
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `del_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0',
  `ETP_ID` int(11) DEFAULT NULL COMMENT '租户',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `wx_fans_msg_res` (
  ...
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `del_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0',
  `ETP_ID` int(11) DEFAULT NULL COMMENT '租户表',
  PRIMARY KEY (`id`) USING BTREE
