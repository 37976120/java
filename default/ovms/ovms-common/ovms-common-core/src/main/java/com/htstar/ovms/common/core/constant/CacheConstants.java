...
public interface CacheConstants {
	 ...
	 * oauth 客户端信息
	 */
	String CLIENT_DETAILS_KEY = GLOBALLY + "ovms_oauth:client:details";
	 ...
	 * 参数缓存
	 */
	String PARAMS_DETAILS = GLOBALLY + "params_details";
	...
	String ADVERT=GLOBALLY+"advert_";
    //批量保存
	String BATCH_SAVE=GLOBALLY+"BATCH";
