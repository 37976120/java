...
import com.htstar.ovms.common.feign.OvmsFeignAutoConfiguration;
 ...
 * @date 2020/2/8
 * <p>
 * interceptor 自动配置功能 from mica
 */
public class OvmsFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
	@Getter
	...
	private Class<?> getSpringFactoriesLoaderFactoryClass() {
		return OvmsFeignAutoConfiguration.class;
	}
