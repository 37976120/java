...
import com.htstar.ovms.act.service.ModelService;
...
public class ModelServiceImpl implements ModelService {
	...
	public Model create(String name, String key, String desc, String category) {
		try {
			...
			properties.put("process_author", SecurityConstants.OVMS_LICENSE);
			...
			model.setTenantId(String.valueOf(TenantContextHolder.getEtpId()));
	...
	public IPage<Model> getModelPage(Map<String, Object> params) {
		ModelQuery modelQuery = repositoryService.createModelQuery()
				.modelTenantId(String.valueOf(TenantContextHolder.getEtpId()))
	...
	public Boolean deploy(String id) {
		try {
			...
			Deployment deployment = repositoryService
					...
					.tenantId(String.valueOf(TenantContextHolder.getEtpId()))
					.deploy();
