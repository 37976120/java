package com.htstar.ovms.pay.config;

import cn.hutool.core.date.DateUtil;
import com.htstar.ovms.common.data.tenant.TenantContextHolder;
import com.htstar.ovms.common.sequence.builder.DbSeqBuilder;
import com.htstar.ovms.common.sequence.properties.SequenceDbProperties;
...
public class SequenceConfig {
	...
	public Sequence paySequence(DataSource dataSource,
		...
		return DbSeqBuilder
				.create()
				.bizName(() -> String.format("pay_%s_%s", TenantContextHolder.getEtpId(), DateUtil.today()))
	...
	public Sequence channelSequence(DataSource dataSource,
		...
		return DbSeqBuilder
				.create()
				.bizName(() -> String.format("channel_%s", TenantContextHolder.getEtpId()))
				.dataSource(dataSource)
				.step(properties.getStep())
				.retryTimes(properties.getRetryTimes())
				.tableName(properties.getTableName())
