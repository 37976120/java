package com.htstar.ovms.manager.api.controller;
...
public class TxManagerController {
	...
	public String sendMsg(@RequestParam("msg") String msg, @RequestParam("protoco") String model) {
		return apiTxManagerService.sendMsg(model, msg);
	}


	@RequestMapping("/sendCompensateMsg")
	public boolean sendCompensateMsg(@RequestParam("protoco") String model, @RequestParam("uniqueKey") String uniqueKey,
