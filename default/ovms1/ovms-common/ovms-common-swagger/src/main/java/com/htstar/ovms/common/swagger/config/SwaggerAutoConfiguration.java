package com.htstar.ovms.common.swagger.config;
...
//		ParameterBuilder versionPar2 = new ParameterBuilder();
//		versionPar2.name("Authorization").description("token")
//				.modelRef(new ModelRef("string")).parameterType("header")
//				.defaultValue("Bearer ")
//				.required(false).build();
		pars.add(versionPar.build());
//		pars.add(versionPar2.build());
