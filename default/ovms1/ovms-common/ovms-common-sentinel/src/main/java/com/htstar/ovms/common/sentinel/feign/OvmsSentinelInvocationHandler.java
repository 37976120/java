 ...
 */
@Slf4j
public class OvmsSentinelInvocationHandler implements InvocationHandler {
	...
	OvmsSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
				...
				try {
					...
					if (fallbackFactory != null) {
						...
						if (R.class == method.getReturnType()) {
							log.error("interceptor 服务间调用异常", ex);
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			OvmsSentinelInvocationHandler other = (OvmsSentinelInvocationHandler) obj;
