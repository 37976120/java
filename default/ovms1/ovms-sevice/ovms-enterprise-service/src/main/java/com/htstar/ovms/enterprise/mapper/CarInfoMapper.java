...
public interface CarInfoMapper extends BaseMapper<CarInfo> {
    ...
    List<Integer> getUsingByCarIds(@Param("etpIds") List<Integer> etpId);
    ...
    List<CarInfo> getBysettingId(Integer settingId);

    Page<CarInfoVo> getapply(@Param("carInfo") CarInfoDTO carInfo);
     ...
     */
    @SqlParser(filter = true)
    List<CarInfo> getapplyStatis(@Param("dto") CarSchedulingDTO carSchedulingDTO);
}
