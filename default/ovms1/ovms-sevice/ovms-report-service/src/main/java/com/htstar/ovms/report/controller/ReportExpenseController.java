...
public class ReportExpenseController {
    ...
    @PostMapping("/carTableByPerson")
    @ApiOperation(value = "费用报表按人统计", notes = "费用报表按人统计")
    public R<IPage<PersonalReportReqVO>> carTableByPerson(@RequestBody CarReportReq req) {
        return reportExpenseService.carTableByPerson(req);
    }
