...
import com.htstar.ovms.report.api.req.CarReportReqNoPage;
...
public interface ReportExpenseMapper extends BaseMapper<ReportExpense> {
    ...
    IPage<PersonalReportReqVO> carTableByPerson(@Param("req") CarReportReq req);

    List<ReportExpense> carTableByPersonNoPage(@Param("req") CarReportReqNoPage carReportReqNoPage);
}
