...
import com.htstar.ovms.daemon.quartz.config.OvmsQuartzFactory;
import com.htstar.ovms.daemon.quartz.entity.SysJob;
import lombok.extern.slf4j.Slf4j;
import org.quartz.*;
import org.springframework.stereotype.Component;

import static com.htstar.ovms.daemon.quartz.constants.OvmsQuartzEnum.*;
	...
	public void addOrUpateJob(SysJob sysjob, Scheduler scheduler) {
		...
		try {
			...
			if (trigger == null) {
				...
				JobDetail jobDetail = JobBuilder.newJob(OvmsQuartzFactory.class).withIdentity(jobKey).build();
				//将任务信息添加到任务信息中
