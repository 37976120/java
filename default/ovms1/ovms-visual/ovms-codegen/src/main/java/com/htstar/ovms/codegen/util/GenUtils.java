package com.htstar.ovms.codegen.util;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.CharsetUtil;
import cn.hutool.core.util.StrUtil;
import com.htstar.ovms.codegen.entity.ColumnEntity;
import com.htstar.ovms.codegen.entity.GenConfig;
import com.htstar.ovms.codegen.entity.GenFormConf;
import com.htstar.ovms.codegen.entity.TableEntity;
import com.htstar.ovms.common.core.constant.CommonConstants;
import com.htstar.ovms.common.core.constant.enums.StyleTypeEnum;
...
public class GenUtils {
	...
	private String getFileName(String template, String className, String packageName, String moduleName) {
		...
		if (template.contains(SERVICE_IMPL_JAVA_VM)) {
			return packagePath + "service" + File.separator + "service" + File.separator + className + "ServiceImpl.java";
		}
